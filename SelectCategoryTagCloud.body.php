...
# CLOUD PARAMETERS - TO BE MOVED TO LOCALSETTINGS.PHP FILE
...
## commenting out - we don't have this JS
...
## not needed
#		$m_pageObj->$m_place .= "<script type=\"text/javascript\" src=\"" . $wgScriptPath . "/extensions/SelectCategoryTagCloud/tabs.js\"></script>\n";
		#ADD CSS 
#		$m_pageObj->$m_place .= "<link type=\"text/css\" href=\"" . $wgScriptPath . "/extensions/SelectCategoryTagCloud/tabs.css\" rel=\"stylesheet\"></link>\n";

//		$m_pageObj->$m_place .= "<link type=\"text/css\" href=\"" . $wgScriptPath . "/extensions/SelectCategoryTagCloud/SelectCategoryTagCloud.css\" rel=\"stylesheet\"></link>\n";	
...
# EOD;
	...
	$m_pageObj->$m_place .= <<<EOD
document.write("<p>Popular Categories</p>");
EOD;
...
function fnSelectCategoryMessageHook() {
	...
	if( file_exists( dirname( __FILE__ ) . '/i18n/SelectCategory.i18n.' . $wgLang->getCode() . '.php' ) ) {
	// avoid warnings
